...
export class Marker {
   ...
   */
  getLoopProxy(loopCheckbox, markerList) {
    ...
    loopProxy.addEventListener("click", () => {
      ...
      markerList.loopManager.toggleLoop();
      const nextMarkerTime = markerList.markers.find((m) => m.time > this.time)?.time;
      const endTime = nextMarkerTime || this.song.player.getAudioElement().duration;
      markerList.loopManager.setLoopBounds(this.time, endTime);
   ...
   */
  getLoopCheckbox(markerList) {
    const loopCheckbox = document.createElement("input");
    loopCheckbox.type = "checkbox";
    loopCheckbox.classList.add("loop-checkbox");
    loopCheckbox.checked = markerList.loopManager.active && markerList.loopManager.start === this.time;
    loopCheckbox.dataset.time = this.time;
    return loopCheckbox;
  }
